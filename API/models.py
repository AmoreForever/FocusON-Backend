...
class User(AbstractUser):
    ...
    user_type = models.CharField(
        choices=USER_TYPE_CHOICES, default="1", null=False, max_length=10
    )
...
class Answer(models.Model):
    question = models.ForeignKey(
        "Question", on_delete=models.CASCADE, default=None, related_name="answer"
    )
...
class StudentAnswer(models.Model):
    ...
    def __str__(self) -> str:
        return (
            ...
            + str(self.exam)
            + "Question : "
            + str(self.question.text)
            + "Answer : "
            + str(self.answer.text)
        )
...
class ExamSupervisors(models.Model):
    supervisor = models.ForeignKey(
        Supervisor, on_delete=models.SET_NULL, null=True, default=None
    )
...
class StudentProgrammingAnswer(models.Model):
    ...
    programming_language = models.CharField(
        choices=programming_languages, default="python3", null=False, max_length=100
    )
