...
class ExamView(APIView):
    ...
    def get(self, request, id):
        try:
            ...
            return JsonResponse(
                status=status.HTTP_404_NOT_FOUND, data={"error": "Exam not found"}
            )
        ...
        exam_info = {
            ...
            "exam_starttime": exam.exam_startdate,
        ...
        try:
            ...
            for question_id, answer_id in student_answers.items():
                ...
                student_answer = StudentAnswer(
                    student=student, exam=exam, answer=answer, question=question
                )
                student_answer.save()
...
class ProgrammingTestView(APIView):
    ...
    def get(self, request, id):
        try:
            ...
            student = Student.objects.get(user=request.user)
            allowed_student = ProgrammingTestAllowedStudents.objects.get(
            ...
            test_info = {
                ...
                "test_starttime": test.test_startdate,
    ...
    def post(self, request, id):
        try:
            ...
            for question_id, arr in student_answers.items():
                ...
                payload = {
                    "clientId": "9d32bd85ad32dd4e5f5b4edf2675ea97",
